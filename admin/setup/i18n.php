...
$messages = array();
$messages['de_DE'] = array('KEY_WITH_PARAM' => 'Meine besonderen Interessen liegen im Bereich {0} und {1} uvm.',
...
echo "<h1>Mit Parameter: " . $withParam->format(array("PHP und OpenSource, Tendoryu Aikido","Parameter")) . "</h1>";
